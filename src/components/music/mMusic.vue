    ...
    <transition>
        <div v-if="readyRender" class="container">
            <div class="container__inner">
                ...
                <n-text :depth="3" style="font-size: 16px;">{{ currentMusic.date }}</n-text>
                <n-grid :x-gap="12" style="align-items: center; margin-top: 48px">
                    <n-gi :span="2">
                    ...
                    <n-gi :span="20">
                        <n-flex vertical :size="24">
                            <n-grid>
                                ...
                                <n-gi :span="24">
                                    <video-player :width="currentMusic.width" :height="currentMusic.height"
